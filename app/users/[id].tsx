...
export default function UserDetailScreen() {
  const { id, group: routeGroup } = useLocalSearchParams<{ id: string; group?: string | string[] }>();
  ...
  const [groupFilter, setGroupFilter] = useState<ApiKeyGroupFilterKey>(() => parseApiKeyGroupFilter(routeGroup));
  ...
  useEffect(() => {
    setGroupFilter(parseApiKeyGroupFilter(routeGroup));
  }, [routeGroup]);
